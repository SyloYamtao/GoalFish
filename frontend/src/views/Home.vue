<template>
  <div class="home-container">
    <!-- 顶部导航栏 -->
    <nav class="navbar">
      <div class="nav-brand">GOALFISH</div>
      <div class="nav-links">
        <LanguageSwitcher />
        <a href="https://github.com/SyloYamtao/GoalFish.git" target="_blank" class="github-link">
      ...
      <section class="hero-section">
        ...
        <div class="hero-right">
          ...
          <div class="logo-container">
            <img src="../assets/logo/GoalFish_logo_compressed.png" alt="GoalFish Logo" class="hero-logo" />
          </div>
...
// 开始预测 - 立即跳转，API调用在 Process 页面进行
const startPrediction = () => {
  if (!canSubmit.value || loading.value) return
  
  // 存储待上传的数据
  import('../store/pendingUpload.js').then(({ setPendingPredictionUpload }) => {
    setPendingPredictionUpload(files.value)
    
    // 立即跳转到 Process 页面（使用特殊标识表示新建项目）
    router.push({
      name: 'Process',
